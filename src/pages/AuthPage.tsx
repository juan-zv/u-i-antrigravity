        ...
        <section className="flex items-center justify-center p-6 sm:p-12 md:p-20 bg-surface">
          <div className="w-full max-w-md">
            <div className="mb-12 flex flex-col items-center lg:items-start">
              ...
              <h2 className="text-3xl font-headline font-black text-on-surface mb-2">Welcome Back</h2>
              <p className="text-on-surface-variant">Access your collegiate transit dashboard</p>
            </div>

            <form className="space-y-6">
              <div className="space-y-2">
                <label
                  className="text-[11px] font-label font-bold uppercase tracking-widest text-on-surface-variant ml-1"
                  htmlFor="email"
                >
                  University Email
                </label>
              ...
              <div className="space-y-2">
                <div className="flex justify-between items-end px-1">
                  <label
                    className="text-[11px] font-label font-bold uppercase tracking-widest text-on-surface-variant"
                    htmlFor="password"
                  >
                    Password
                  </label>
                  <a
                    className="text-[11px] font-label font-bold text-secondary uppercase tracking-widest hover:underline transition-all"
                    href="#"
                  >
                    Forgot?
                  </a>
              ...
              <div className="pt-2">
                <button
                  className="w-full bg-primary text-on-primary py-4 px-6 rounded-full font-headline font-bold text-base hover:opacity-90 active:scale-[0.98] transition-all flex items-center justify-center gap-2 shadow-lg shadow-primary/10"
                  type="submit"
                >
            ...
            <div className="mt-12">
              <div className="relative">
                ...
                <div className="relative flex justify-center text-xs uppercase tracking-widest font-label font-bold">
                  <span className="bg-surface px-4 text-outline">New to U&I Ride?</span>
                </div>
              </div>
                ...
                <div className="bg-surface-container-low p-6 rounded-lg border border-outline-variant/10 relative overflow-hidden group">
                  <div className="relative z-10">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <h4 className="text-sm font-headline font-bold text-on-surface">Create Academic Account</h4>
                    </div>
                    <p className="text-xs text-on-surface-variant mb-6 leading-relaxed">
                      Verification requires an active university email and student identification number.
                    </p>
